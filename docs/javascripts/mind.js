...
(function () {
  ...
  var NODES = [
    ...
    { id: "ag-flowie",        label: "flowie",          type: "agent", tags: ["human","memory"],     desc: "Personal identity agent — reads flowie profile and surfaces active tasks for the current project at session start; shapes assistance to the user's intellectual fingerprint without exposing profile data in external outputs.",                   url: "concepts/agents/" },
