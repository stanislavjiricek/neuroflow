...
- **[`/lit-review`](commands/lit-review.md)** — structured post-retrieval literature analysis; applies 12 named protocols to a paper corpus retrieved by `/ideation` or the `scholar` agent: [The Intake Protocol](skills/lit-review-protocols/SKILL.md#protocol-1--the-intake-protocol), [The Contradiction Hunter](skills/lit-review-protocols/SKILL.md#protocol-2--the-contradiction-hunter), [The Knowledge Gap Detector](skills/lit-review-protocols/SKILL.md#protocol-3--the-knowledge-gap-detector), [The Timeline Builder](skills/lit-review-protocols/SKILL.md#protocol-4--the-timeline-builder), [The Methodology Auditor](skills/lit-review-protocols/SKILL.md#protocol-5--the-methodology-auditor), [The Citation Network Map](skills/lit-review-protocols/SKILL.md#protocol-6--the-citation-network-map), [The Lit Review Writer](skills/lit-review-protocols/SKILL.md#protocol-7--the-lit-review-writer), [The Devil's Advocate](skills/lit-review-protocols/SKILL.md#protocol-8--the-devils-advocate), [The Theoretical Framework Extractor](skills/lit-review-protocols/SKILL.md#protocol-9--the-theoretical-framework-extractor), [The Variable Map](skills/lit-review-protocols/SKILL.md#protocol-10--the-variable-map), [The Plain Language Translator](skills/lit-review-protocols/SKILL.md#protocol-11--the-plain-language-translator), and [The Future Research Agenda](skills/lit-review-protocols/SKILL.md#protocol-12--the-future-research-agenda)
