...
- `neuroflow:humanizer` — run on every drafted section before the critic review; strips AI signatures, fixes rhythm, and calibrates register so the prose reads as genuinely human-authored
