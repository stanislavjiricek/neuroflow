...
3. Flag variables present in 70% or more of papers as dominant variables (for corpora of 5–20 papers, lower the threshold to 60%; for corpora of 50+ papers, raise it to 80%)
